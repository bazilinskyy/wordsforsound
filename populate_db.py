...
sound_full_6sec= models.Sound(name="Full 6 dec",
			filename="FINAL_Full_6Sec+Level3.wav",
			sound_type="1")
...
sound_dev_brake = models.Sound(name="Brake dev",
			...
			sound_type="1")
sound_dev_brake.tag_add(tag_playful)
sound_dev_brake.tag_add(tag_fussy)
sound_dev_brake.tag_add(tag_starting)
sound_dev_brake.tag_add(tag_transition)
...
# Add assets
asset1_1 = models.Asset(name="Asset 1A",
...
asset1_2 = models.Asset(name="Asset 2A",
...
description1_1 = models.Description(duration="200",
        		...
        		user=benjamin_mathe,
        		timestamp=datetime.now())
description1_1.tag_add(models.Tag.query.filter_by(name=tag_beep.name).first())
description1_1.tag_add(models.Tag.query.filter_by(name=tag_urgent4.name).first())
description1_1.tag_add(models.Tag.query.filter_by(name=tag_tor.name).first())
description1_1.tag_add(models.Tag.query.filter_by(name=tag_critical.name).first())
description1_1.tag_add(models.Tag.query.filter_by(name=tag_automated.name).first())
description1_1.tag_add(models.Tag.query.filter_by(name=tag_worthy.name).first())
description1_1.tag_add(models.Tag.query.filter_by(name=tag_wooden.name).first())
description1_1.tag_add(models.Tag.query.filter_by(name=tag_directional.name).first())
description1_1.tag_add(models.Tag.query.filter_by(name=tag_safe.name).first())
description1_1.tag_add(models.Tag.query.filter_by(name=tag_warning.name).first())
description1_1.sound_add(models.Sound.query.filter_by(name=sound_nova_63.name).first())
description1_1.sound_add(models.Sound.query.filter_by(name=sound_uc2_tor_obstacle.name).first())
description1_1.sound_add(models.Sound.query.filter_by(name=sound_beep_freezman.name).first())
description1_2 = models.Description(duration="65",
                ...
                user=benjamin_mathe,
                timestamp=datetime.now())
description1_2.tag_add(models.Tag.query.filter_by(name=tag_calm.name).first())
description1_2.tag_add(models.Tag.query.filter_by(name=tag_notification.name).first())
description1_2.tag_add(models.Tag.query.filter_by(name=tag_lane_switch.name).first())
description1_2.tag_add(models.Tag.query.filter_by(name=tag_automated.name).first())
description1_2.sound_add(models.Sound.query.filter_by(name=sound_nova_12.name).first())
description1_2.sound_add(models.Sound.query.filter_by(name=sound_uc4_overtaking.name).first())
description1_2.sound_add(models.Sound.query.filter_by(name=sound_drum_tom.name).first())
...
# Add assets
asset2_1 = models.Asset(name="Asset 1B",
				description="Beep-like sound for an urgent take-over request in a critical situation with TTC less than or equal 5 sec (e.g. sudden serious traffic accident in the lane of the automated car). It should sound worthy, with a touch of \"wooden\" sound. The sound should be directional: it should point to the the safest maneuver (right/left). It may include speech.",
        		status=models.AssetStatus.iteration.value,
        		project=project_auditory_test_1,
        		finished=False,
        		...
        		timestamp=datetime.now(),
        		notify_by_email=True)
asset2_2 = models.Asset(name="Asset 2B",
				description="Not loud and not very intrusive notification for the situation when a highly automated car decides to switch lanes in automated mode. Without speech (similar to UC4_Overtaking.wav, but without speech).",
                status=models.AssetStatus.iteration.value,
                project=project_auditory_test_1,
                finished=False,
...
description2_1.tag_add(models.Tag.query.filter_by(name=tag_beep.name).first())
description2_1.tag_add(models.Tag.query.filter_by(name=tag_urgent4.name).first())
description2_1.tag_add(models.Tag.query.filter_by(name=tag_tor.name).first())
description2_1.tag_add(models.Tag.query.filter_by(name=tag_critical.name).first())
description2_1.tag_add(models.Tag.query.filter_by(name=tag_automated.name).first())
description2_1.tag_add(models.Tag.query.filter_by(name=tag_worthy.name).first())
description2_1.tag_add(models.Tag.query.filter_by(name=tag_wooden.name).first())
description2_1.tag_add(models.Tag.query.filter_by(name=tag_directional.name).first())
description2_1.tag_add(models.Tag.query.filter_by(name=tag_safe.name).first())
description2_1.tag_add(models.Tag.query.filter_by(name=tag_warning.name).first())
description2_1.sound_add(models.Sound.query.filter_by(name=sound_nova_63.name).first())
description2_1.sound_add(models.Sound.query.filter_by(name=sound_uc2_tor_obstacle.name).first())
description2_1.sound_add(models.Sound.query.filter_by(name=sound_beep_freezman.name).first())
...
description2_2.tag_add(models.Tag.query.filter_by(name=tag_calm.name).first())
description2_2.tag_add(models.Tag.query.filter_by(name=tag_notification.name).first())
description2_2.tag_add(models.Tag.query.filter_by(name=tag_lane_switch.name).first())
description2_2.tag_add(models.Tag.query.filter_by(name=tag_automated.name).first())
description2_2.sound_add(models.Sound.query.filter_by(name=sound_nova_12.name).first())
description2_2.sound_add(models.Sound.query.filter_by(name=sound_uc4_overtaking.name).first())
description2_2.sound_add(models.Sound.query.filter_by(name=sound_drum_tom.name).first())
...
# Add assets
asset3_1 = models.Asset(name="Asset 1C",
				description="Beep-like sound for an urgent take-over request in a critical situation with TTC less than or equal 5 sec (e.g. sudden serious traffic accident in the lane of the automated car). It should sound worthy, with a touch of \"wooden\" sound. The sound should be directional: it should point to the the safest maneuver (right/left). It may include speech.",
        		status=models.AssetStatus.iteration.value,
        		project=project_auditory_test_1,
        		finished=False,
        		...
        		timestamp=datetime.now(),
        		notify_by_email=True)
asset3_2 = models.Asset(name="Asset 2C",
				description="Not loud and not very intrusive notification for the situation when a highly automated car decides to switch lanes in automated mode. Without speech (similar to UC4_Overtaking.wav, but without speech).",
                status=models.AssetStatus.iteration.value,
                project=project_auditory_test_1,
                finished=False,
...
description3_1 = models.Description(duration="200",
        		...
        		user=benjamin_mathe,
        		timestamp=datetime.now())
description3_1.tag_add(models.Tag.query.filter_by(name=tag_beep.name).first())
description3_1.tag_add(models.Tag.query.filter_by(name=tag_urgent4.name).first())
description3_1.tag_add(models.Tag.query.filter_by(name=tag_tor.name).first())
description3_1.tag_add(models.Tag.query.filter_by(name=tag_critical.name).first())
description3_1.tag_add(models.Tag.query.filter_by(name=tag_automated.name).first())
description3_1.tag_add(models.Tag.query.filter_by(name=tag_worthy.name).first())
description3_1.tag_add(models.Tag.query.filter_by(name=tag_wooden.name).first())
description3_1.tag_add(models.Tag.query.filter_by(name=tag_directional.name).first())
description3_1.tag_add(models.Tag.query.filter_by(name=tag_safe.name).first())
description3_1.tag_add(models.Tag.query.filter_by(name=tag_warning.name).first())
description3_1.sound_add(models.Sound.query.filter_by(name=sound_nova_63.name).first())
description3_1.sound_add(models.Sound.query.filter_by(name=sound_uc2_tor_obstacle.name).first())
description3_1.sound_add(models.Sound.query.filter_by(name=sound_beep_freezman.name).first())
...
description3_2.tag_add(models.Tag.query.filter_by(name=tag_calm.name).first())
description3_2.tag_add(models.Tag.query.filter_by(name=tag_notification.name).first())
description3_2.tag_add(models.Tag.query.filter_by(name=tag_lane_switch.name).first())
description3_2.tag_add(models.Tag.query.filter_by(name=tag_automated.name).first())
description3_2.sound_add(models.Sound.query.filter_by(name=sound_nova_12.name).first())
description3_2.sound_add(models.Sound.query.filter_by(name=sound_uc4_overtaking.name).first())
description3_2.sound_add(models.Sound.query.filter_by(name=sound_drum_tom.name).first())
