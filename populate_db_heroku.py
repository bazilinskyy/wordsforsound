...
# Add projects
project_auditory_test = models.Project(name="AD overtaking 6",
				description="In this we will be developing auditory assets for take-over requests during highly automated driving.",
				filename="icad 2015.pdf",
				finished=False,
				user=test_user,
...
################## Tester 7 ##################
# Add users
test_user = models.ClientUser(nickname="olexii_drozdenko",
				first_name="Oleksii",
				last_name="Drozdenko",
                email="oleksii.drozdenko@gmail.com",
                password="12345678",
                last_seen=datetime.now(),
                receive_emails=True)
jim = models.ClientUser(nickname="jim_clark7",
				first_name="Jim",
				last_name="Clark",
                email="wordsforsound.jim7@gmail.com",
                password="12345678",
                last_seen=datetime.now(),
                receive_emails=True,
                avatar_filename="jim_70.jpg")
ayrton = models.SupplierUser(nickname="ayrton_senna7",
				first_name="Ayrton",
				last_name="Senna",
                email="wordsforsound.ayrton7@gmail.com",
                password="12345678",
                last_seen=datetime.now(),
                receive_emails=True,
                avatar_filename="ayrton_70.jpg")
michael = models.SupplierUser(nickname="michael_schumacher7",
				first_name="Michael",
				last_name="Schumacher",
                email="wordsforsound.michael7@gmail.com",
                password="12345678",
                last_seen=datetime.now(),
                receive_emails=True,
                avatar_filename="michael_70.jpg")
niki = models.SupplierUser(nickname="niki_lauda7",
				first_name="Niki",
				last_name="Lauda",
                email="wordsforsound.niki7@gmail.com",
                password="12345678",
                last_seen=datetime.now(),
                receive_emails=False,
                avatar_filename="niki_70.jpg")
...
# Add projects
project_auditory_test = models.Project(name="AD overtaking 7",
				description="In this we will be developing auditory assets for take-over requests during highly automated driving.",
				filename="icad 2015.pdf",
				finished=False,
				user=test_user,
...
################## Tester 8 ##################
# Add users
test_user = models.ClientUser(nickname="oscar_mendoza",
				first_name="Oscar",
				last_name="Mendoza",
                ...
                last_seen=datetime.now(),
                receive_emails=True)
jim = models.ClientUser(nickname="jim_clark8",
				first_name="Jim",
				last_name="Clark",
                email="wordsforsound.jim8@gmail.com",
                password="12345678",
                last_seen=datetime.now(),
                receive_emails=True,
                avatar_filename="jim_70.jpg")
ayrton = models.SupplierUser(nickname="ayrton_senna8",
				first_name="Ayrton",
				last_name="Senna",
                email="wordsforsound.ayrton8@gmail.com",
                password="12345678",
                last_seen=datetime.now(),
                receive_emails=True,
                avatar_filename="ayrton_70.jpg")
michael = models.SupplierUser(nickname="michael_schumacher8",
				first_name="Michael",
				last_name="Schumacher",
                email="wordsforsound.michael8@gmail.com",
                password="12345678",
                last_seen=datetime.now(),
                receive_emails=True,
                avatar_filename="michael_70.jpg")
niki = models.SupplierUser(nickname="niki_lauda8",
				first_name="Niki",
				last_name="Lauda",
                email="wordsforsound.niki8@gmail.com",
                password="12345678",
                last_seen=datetime.now(),
                receive_emails=False,
                avatar_filename="niki_70.jpg")
...
# Add projects
project_auditory_test = models.Project(name="AD overtaking 8",
				description="In this we will be developing auditory assets for take-over requests during highly automated driving.",
				filename="icad 2015.pdf",
				finished=False,
				user=test_user,
